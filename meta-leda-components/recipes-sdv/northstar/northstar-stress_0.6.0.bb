...
# how to get northstar-stress could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/northstar-stress/0.6.0"
...
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "northstar-stress"
...
include northstar-stress-${PV}.inc
include northstar-stress.inc
