...
# how to get northstar-client could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/northstar-client/0.6.0"
...
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "northstar-client"
...
include northstar-client-${PV}.inc
include northstar-client.inc
