...
# how to get northstar-runtime could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/northstar-runtime/0.6.0"
...
S = "${WORKDIR}/git"
CARGO_SRC_DIR = "northstar-runtime"
...
include northstar-runtime-${PV}.inc
include northstar-runtime.inc
