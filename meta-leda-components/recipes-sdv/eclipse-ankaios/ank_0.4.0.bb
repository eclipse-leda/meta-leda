...
SUMMARY = "Eclipse Ankaios CLI - workload and container orchestration for automotive HPCs"
DESCRIPTION = "Eclipse Ankaios provides workload and container orchestration for \
automotive High Performance Computing Software (HPCs). The ank CLI tool \
allows users to interact with the Ankaios server to manage workloads."
