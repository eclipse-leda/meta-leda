...
SUMMARY = "Eclipse Ankaios agent - workload and container orchestration for automotive HPCs"
DESCRIPTION = "Eclipse Ankaios provides workload and container orchestration for \
automotive High Performance Computing Software (HPCs). The agent component \
runs on each node and executes workloads as directed by the server."
