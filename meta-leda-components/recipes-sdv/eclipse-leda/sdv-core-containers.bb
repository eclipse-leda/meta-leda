...
# Moved to KANTO_MANIFESTS_LOCAL_DEV_DIR
...
# Moved to KANTO_MANIFESTS_LOCAL_DIR
    #install ${THISDIR}/kanto-containers/core_dev/databroker.json ${D}${KANTO_MANIFESTS_LOCAL_DEV_DIR}
    #install ${THISDIR}/kanto-containers/core_dev/vum.json ${D}${KANTO_MANIFESTS_LOCAL_DEV_DIR}
    #install ${THISDIR}/kanto-containers/core_dev/sua.json ${D}${KANTO_MANIFESTS_LOCAL_DEV_DIR}
